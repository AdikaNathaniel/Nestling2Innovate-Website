...
const ICONS = {
  ...
  instagram: (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="#E4405F" aria-hidden="true">
  ...
  x: (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="#000000" aria-hidden="true">
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col" id="contact">
            ...
            <ul>
              <li>
                Special Grace Academy Campus,<br />
                Tantra Hills, 2nd Street,<br />
                behind Champion Divine Clinic,<br />
                Accra, Ghana
              </li>
